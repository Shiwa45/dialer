    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('force_rport', models.CharField(blank=True, default='yes', max_length=3)),
                ('rewrite_contact', models.CharField(blank=True, default='yes', max_length=3)),
                ('mailboxes', models.CharField(blank=True, default='', max_length=80)),
                ('media_encryption', models.CharField(blank=True, default='dtls', max_length=20)),
                ('use_avpf', models.CharField(blank=True, default='yes', max_length=3)),
                ('ice_support', models.CharField(blank=True, default='yes', max_length=3)),
                ('media_use_received_transport', models.CharField(blank=True, default='yes', max_length=3)),
                ('rtcp_mux', models.CharField(blank=True, default='yes', max_length=3)),
                ('dtls_verify', models.CharField(blank=True, default='fingerprint', max_length=20)),
                ('dtls_setup', models.CharField(blank=True, default='actpass', max_length=20)),
                ('webrtc', models.CharField(blank=True, default='yes', max_length=3)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_type', models.CharField(choices=[('ip', 'IP Based'), ('registration', 'Registration Based')], default='ip', max_length=20)),
                ...
                ('nat', models.CharField(default='force_rport,comedia', max_length=20)),
                ('dial_prefix', models.CharField(blank=True, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dids', to='telephony.carrier')),
            ],
            options={
                'verbose_name': 'DID',
